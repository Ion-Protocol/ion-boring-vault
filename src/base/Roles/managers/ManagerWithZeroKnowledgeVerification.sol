...
import {ManageVerifier} from "src/zk-verifiers/ManageVerifier.sol";

contract ManagerWithZeroKnowledgeVerification is Auth, ManageVerifier {
     ...
     */
    function manageVaultWithZeroKnowledgeVerification(
        ManageVerifier.Proof[] calldata manageProofs,
    ...
    function _verifyCallData(
        ...
        ManageVerifier.Proof calldata manageProof,
    ...
    function _verifyManageProof(
        bytes32 root,
        ManageVerifier.Proof calldata proof,
        address target,
        address decoderAndSanitizer,
        uint256 value,
        bytes4 selector,
        ...
        return verifyTx(leaf, root, nonce, proof);
    }
}
