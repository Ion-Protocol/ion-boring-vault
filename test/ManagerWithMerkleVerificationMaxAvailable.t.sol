...
contract ManagerWithMerkleVerificationMaxAvailableTest is Test, MainnetAddresses {
    ...
    bytes32 public MAX_AVAILABLE_MARKER;
    ...
    function setUp() external {
        ...
        EtherFiLiquidDecoderAndSanitizer decoderAndSanitizer =
            new EtherFiLiquidDecoderAndSanitizer(address(boringVault), uniswapV3NonFungiblePositionManager);
        rawDataDecoderAndSanitizer = address(decoderAndSanitizer);
        MAX_AVAILABLE_MARKER = decoderAndSanitizer.MAX_AVAILABLE_MARKER();
